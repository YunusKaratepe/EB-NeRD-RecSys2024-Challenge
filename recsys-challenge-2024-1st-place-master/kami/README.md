...
**Datasets are now in the input folder:**
```
recsys-challenge-2024-1st-place-master/kami/input/
├── ebnerd_small/
├── ebnerd_medium/
└── ebnerd_large/
```
...
- Small dataset already at: `input/ebnerd_small/`

**Option B: Use Medium Dataset** (recommended)
- Medium dataset at: `input/ebnerd_medium/`
- Or create it: `python create_medium_dataset.py`

**Option C: Use Full Large Dataset** (requires 768GB RAM)
- Large dataset at: `input/ebnerd_large/`
